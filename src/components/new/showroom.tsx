  ...
  return (
    <li>
      {href ? (
        <a
          href={href}
          className="flex items-center gap-4 transition-colors hover:text-clay"
        >
          {content}
        </a>
      ) : (
...
export function ShowroomNew() {
  return (
    <section id="showroom" className="scroll-mt-20 pt-24 sm:pt-32">
      <SectionTitleNew
        eyebrow="Контакты"
      ...
      <div className="mx-auto mt-12 grid max-w-7xl gap-6 px-5 sm:px-8 lg:grid-cols-2">
        {/* Фото шоурума */}
        <div className="relative aspect-[4/3] overflow-hidden rounded-3xl lg:aspect-auto lg:h-full">
          <Image
        ...
        <div className="flex flex-col gap-6">
          <div className="rounded-3xl border border-stone bg-sand p-7 sm:p-8">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3 border-t border-stone pt-6">
            ...
            <a
              href="#quiz"
              className="mt-6 inline-flex h-13 w-full items-center justify-center rounded-full bg-clay px-7 font-semibold text-white transition-colors hover:bg-clay-dark"
            >
              Записаться на визит
            </a>
          </div>
