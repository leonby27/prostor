      ...
      <RevealGroup className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
        {advantages.map((a) => (
          <RevealItem key={a.title}>
            <div className="group h-full rounded-2xl border border-stone bg-sand/60 p-7 transition-all duration-300 hover:-translate-y-1 hover:border-clay/30 hover:bg-white hover:shadow-card">
